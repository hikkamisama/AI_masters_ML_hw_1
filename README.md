## Первая домашка по МО - первая часть
...
[Задеплоенное приложение](https://aimasters-ml-hw1.streamlit.app)

Приложение достаточно удобно в использовании, но возможно стоило бы реализовать сохранение истории запросов и ответов

Не очень удачно вышли графики - они включены как картинки, так как не было желания прогонять заново все преобразования над датасетом из колаба локально для получения нужных таблиц для графиков, возможно, над этим надо поработать.